  ...
  en: {
    ...
    services: {
      ...
      moto: {
        ...
        tag: 'Bali Rides',
        title: 'RIDING GUIDE',
        desc: 'Private full-day riding tours around Bali. Hidden roads, local spots, real adventure.',
        cta: 'Enquire via DM',
      },
    },
    footer: {
  ...
  id: {
    ...
    services: {
      ...
      moto: {
        ...
        desc: 'Tur riding privat seharian keliling Bali. Jalan tersembunyi, spot lokal, petualangan nyata.',
        cta: 'Tanya via DM',
      },
    },
    footer: {
